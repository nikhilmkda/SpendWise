...
void main() {
          ...
          home: Scaffold(
            ...
            body: Consumer<ExpenseData>(
              builder: (context, expenseData, _) {
                // You can use mockExpenseDataProvider to interact with the ExpenseData provider
                // and test its functionality here.
                return const Placeholder(); // Replace with your test content.
              },
            ),
          ),
        ));
  ...
  testWidgets('Test ExpenseData Provider', (WidgetTester tester) async {
    // Build your widget tree
    await tester.pumpWidget(createwidgetundertest());

    
 // Create a sample expense item
  final sampleExpense = ExpenseItem(
    name: 'Sample Expense',
    amount: '100.0',
    dateTime: DateTime.now(), id: UniqueKey().toString(),
  );
